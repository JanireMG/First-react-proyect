...
export default class portfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo:"",
            editMode: false,
            apiUrl: "https://jani.devcamp.space/portfolio/portfolio_items",
            apiAction: "post",
        }
    ...
    UNSAFE_componentDidUpdate() {
        if(Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://jani.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch", // Use patch for updates
    ...
    componentConfig(){
        return{
           ...
           postUrl: "https://httpbin.org/post" // This is a dummy URL for testing
        }
    }
                ...
                <div>
                    ...
                    <div className="image-uploaders">
                        {this.state.thumb_image_url && this.state.editMode ? (
                            ...
                            // Display the thumbnail if it exists and in edit mode, else show dropzone
                        ) : (
                        <DropzoneComponent
                            ref = {this.thumbRef}
